...
echo  Stack: Python 3.12 + PyTorch 2.8 + CUDA 12.8
echo ============================================================
echo.
...
echo [0/7] Ensuring Pixal3D source ...
...
echo [3/7] Installing PyTorch 2.8 + cu128 ...
%PIP% install torch==2.8.0 torchvision==0.23.0 --index-url https://download.pytorch.org/whl/cu128
if errorlevel 1 exit /b 1

echo [4/7] Installing Pixal3D Python dependencies ...
...
echo [5/7] Installing Windows CUDA wheels (cu128 / torch2.8 / cp312) ...
%PIP% install --no-deps ^
...
echo [6/7] Web UI deps + import aliases ...
